...
<!--                                        <select id="carID" name="carID" required>
            ...
            <script>
                ...
                // Function to open the edit driver modal with driver data
                ...
                // Add this to the Add New Driver button in the drivers section
                document.addEventListener('DOMContentLoaded', function () {
                    var addDriverBtn = document.querySelector('#driversSection .btn-primary');
                    if (addDriverBtn) {
                        addDriverBtn.addEventListener('click', openAddDriverModal);
                    }
                });
                document.addEventListener('DOMContentLoaded', function () {
                    var deleteDriverBtn = document.querySelector('#driversSection .btn-new');
                    if (deleteDriverBtn) {
                        deleteDriverBtn.addEventListener('click', openDeleteModal);
                    }
                });
            </script>
    </body>
