        ...
        <div class="main-container">
            ...
            <div class="form-container">
                <div class="form-content">
                    ...
                    <form id="signUpForm" action="<%= request.getContextPath()%>/SignUpServlet" method="POST">
                        <div class="form-group">
                            <input id="customername" name="customername" type="text" placeholder="Customer Name" class="form-input"/>
                            <div id="customernameError" class="input-error"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <input id="nic" name="nic" type="text" placeholder="NIC" class="form-input"/>
                            <div id="nicError" class="input-error"></div>
                        </div>
