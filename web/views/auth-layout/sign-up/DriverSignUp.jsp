            ...
            <div class="form-container">
                <div class="form-content">
                    ...
                    <form id="driverSignUpForm" action="<%= request.getContextPath()%>/DriverSignUpServlet" method="POST">
                        ...
                        <div class="form-group">
                            <input id="model" name="model" type="text" placeholder="Vehicle Model" class="form-input"/>
                            <div id="driverLicenseError" class="input-error"></div>
                        </div>
                        
                        <div class="form-group">
                            <input id="year" name="year" type="number" placeholder="Vehicle Year" class="form-input"/>
                            <div id="driverLicenseError" class="input-error"></div>
                        </div>
